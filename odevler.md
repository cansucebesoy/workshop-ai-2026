...
| NULL | [İrem Tuğba Sağsöz](https://github.com/iremsagsoz) | [ai-code-review-agent](https://github.com/iremsagsoz/ai-code-review-agent) | Python, FastAPI, Gemini API | Python dosyalarını veya projelerini Google Gemini API ile analiz eden, güvenlik ve kod kalitesi değerlendirmeleri yaparak detaylı rapor oluşturan AI Code Review Agent. |
## Kendini Ekle
